...
def dotImplementations : List (BenchmarkImplementation (FloatArray → FloatArray → Float)) := [
  ...
  { id := "lean.floatArrayDot.usize_rec_uget_bound"
    language := "lean"
    name := "Lean usize_rec_uget_bound"
    sourceFile := "NumLeanPerf/FloatArrayDot/Implementations.lean"
    symbol := "floatArrayDot.usize_rec_uget_bound"
    run := floatArrayDot.usize_rec_uget_bound },
  { id := "lean.floatArrayDot.usize_range_uget"
    language := "lean"
    name := "Lean usize_range_uget"
    sourceFile := "NumLeanPerf/FloatArrayDot/Implementations.lean"
    symbol := "floatArrayDot.usize_range_uget"
    run := floatArrayDot.usize_range_uget },
