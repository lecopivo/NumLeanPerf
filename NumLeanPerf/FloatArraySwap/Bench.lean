...
def swapImplementations : List (BenchmarkImplementation (FloatArray → FloatArray → FloatArray × FloatArray)) := [
  ...
  { id := "lean.floatArraySwap.usize_rec_uget_bound"
    language := "lean"
    name := "Lean usize_rec_uget_bound"
    sourceFile := "NumLeanPerf/FloatArraySwap/Implementations.lean"
    symbol := "floatArraySwap.usize_rec_uget_bound"
    run := floatArraySwap.usize_rec_uget_bound },
  { id := "lean.floatArraySwap.usize_range_uget"
    language := "lean"
    name := "Lean usize_range_uget"
    sourceFile := "NumLeanPerf/FloatArraySwap/Implementations.lean"
    symbol := "floatArraySwap.usize_range_uget"
    run := floatArraySwap.usize_range_uget },
  { id := "lean.floatArraySwap.usize_range_unsafe_set"
    language := "lean"
    name := "Lean usize_range_unsafe_set"
    sourceFile := "NumLeanPerf/FloatArraySwap/Implementations.lean"
    symbol := "floatArraySwap.usize_range_unsafe_set"
    run := floatArraySwap.usize_range_unsafe_set },
