...
def sinImplementations : List (BenchmarkImplementation (FloatArray → FloatArray)) := [
  ...
  { id := "lean.floatArraySin.usize_range_uget"
    language := "lean"
    name := "Lean usize_range_uget"
    sourceFile := "NumLeanPerf/FloatArraySin/Implementations.lean"
    symbol := "floatArraySin.usize_range_uget"
    run := floatArraySin.usize_range_uget },
  { id := "lean.floatArraySin.usize_range_unsafe_set"
    language := "lean"
    name := "Lean usize_range_unsafe_set"
    sourceFile := "NumLeanPerf/FloatArraySin/Implementations.lean"
    symbol := "floatArraySin.usize_range_unsafe_set"
    run := floatArraySin.usize_range_unsafe_set },
